...
# Collection settings
COLLECTION_PHASE = "simulated_pothole"
COLLECTION_TIME = 60  # 1 minute
...
# Add prompt for user
print("TAP OR BUMP THE SENSORS SEVERAL TIMES to simulate potholes during recording!")
print("Use firm, quick taps - not gentle touches. Aim for 10-15 good impacts.")
...
print("REMINDER: Use firm taps to simulate potholes!")
...
with open(FILENAME, 'w') as f:
    ...
    for i in range(3, 0, -1):
        print(i)
        time.sleep(1)
    print("GO! Start tapping to simulate potholes!")
